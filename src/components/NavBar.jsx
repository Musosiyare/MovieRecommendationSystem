...
function NavBar() {
  return (
    <div className='flex justify-between items-center p-4 z-[100] w-full sticky top-0 bg-black-900'>
        <Link to='/'><h1 className='text-red-600 text-4xl font-bold cursor-pointer'><span className='text-white'>Movie</span>.here.</h1></Link>
        <div>
          <input type="search" name="search" id="" placeholder='Seach here...' className='p-2 rounded' />
